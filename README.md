...
initGRASS(gisBase = "/usr/lib/grass72/",
          home = tempdir(),
          override = TRUE)
#> gisdbase    /tmp/RtmpprJDfy 
#> location    file1f5f473f9fef 
#> mapset      file1f5f56bf501e 
#> rows        1 
#> columns     1 
#> north       1 
#> south       0 
...
#> Source: "/tmp/RtmpprJDfy/file1f5f473f9fef/PERMANENT/.tmp/mira-Linux/127.0", layer: "sites"
#> with 87 features
#> It has 15 fields
sites <- readVECT("sites", ignore.stderr = TRUE)
head(sites@data)
