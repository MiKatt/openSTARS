...
preds_path <- system.file("extdata", "nc", "pointsources.shp", package = "openSTARS")
preds_r_path <- system.file("extdata", "nc", "landuse_r.tif", package = "openSTARS")
import_data(dem = dem_path, sites = sites_path, predictor_vector = preds_path, predictor_v_names = "psources", predictor_raster = preds_r_path)
```
...
segment is moved a small fraction of the cell size of the DEM downstream. The outflowing
segment is split into tow parts at this new junction. All features are corrected
accordingly (cat, length, prev_str01, prev_str02, next_str etc.). 
...
calc_prediction_sites(predictions = "preds", nsites = 100, netIDs = 47 )
```
...
calc_attributes_edges(input_raster = c("slope", "landuse_r"), stat_rast = c("mean", "percent"),
                      ...
                      round_dig = 4)#, input_vector = "landuse", stat_vect = "percent", attr_name_vect = "landuse", 
