...
correct_compl_junctions <- function(clean = TRUE, celltoldig = 2){
  ...
  if ("prev_str05" %in% cnames)
    stop("There are five or more inflows to one outflow. Currently, this
         function only works for complex juctions with up to four inflows.")
